...
class MainActivityUseCase @Inject constructor(
    ...
    suspend fun getAllBannerListing(): ArrayList<BannerDataModel> {
        ...
        bannerList.add(BannerDataModel(1,"Fruit", arrayListOf("Apple","Banana","Orange","kiwi","Mangos","Graphes","Cherry","Guava","Pomegranate","Sweet Lime") , R.drawable.fruits))
        bannerList.add(BannerDataModel(2,"Vegetable", arrayListOf("Tomato","Potato","Pea","Cabbage","Ginger") , R.drawable.vegetables))
        bannerList.add(BannerDataModel(3,"Bird", arrayListOf("Duck","Crow","Canary","Peacock") , R.drawable.birds))
        bannerList.add(BannerDataModel(4,"Gadget", arrayListOf("Mobile","Laptop","Charger") , R.drawable.gadgets))
